      ...
      <div className="page-wrapper">
        ...
        <section
          ...
          style={
            {
              position:"relative",
              // background: "url(assets/images/backgrounds/section-2-1-bg.png)",
        ...
        >
          <Image
            src="/assets/images/backgrounds/section-2-1-bg.png"
            fill
              ...
              <div className="col-lg-9 wow fadeInRight" data-wow-delay="300ms">
                <div className="about-one__inner">
                  <div className="about-one__content">
                    ...
                    >
                      Every expert in our network is hand-vetted for <br className="d-none d-lg-inline" /> qualifications, credibility, and courtroom readiness. With <br className="d-none d-lg-inline" /> national reach and specialized knowledge across<br className="d-none d-lg-inline" />disciplines, we match you with professionals who support <br className="d-none d-lg-inline" /> your case with clarity and conviction.
                    </p>
          ...
          <div className="container margin-tailored p-md-0">
            <div className="">
              ...
              >
                ...
                for niche expertise, our team actively recruits and verifies new
                experts on your behalf, managing outreach, vetting, and
