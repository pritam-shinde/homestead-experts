...
//      <section className="main-slider-one" id="home">
//             <div className="main-slider-one__carousel procounsel-owl__carousel owl-carousel"
//               data-owl-options='{		"loop": true,		"animateOut": "fadeOut",		"animateIn": "fadeIn",		"items": 1,		"autoplay": true,		"autoplayTimeout": 7000,
// 		"smartSpeed": 1000,		"nav": false,"navText": ["<span className=\"icon-arrow-left\"></span>","<span className=\"icon-arrow-right\"></span>"],"dots": true,		"margin": 0}'
//             >
//               <div className="item">
//                 <div className="main-slider-one__item">
//                   <div
//                     className="main-slider-one__bg" style={{ backgroundImage: "url('/assets/images/backgrounds/slider-1.jpg')" }}></div>
//                   {/* <!-- bg --> */}
//                   <div className="main-slider-one__overlay-one"></div>
//                   <div className="main-slider-one__overlay-two"></div>
//                   <div className="container">
...
//                             The Expert Witness <br />company That Helps
//                             <br /> You Fight ALL Cases
//                           </h2>
//                           {/* <!-- slider-title --> */}
...
//               <div className="item">
//                 <div className="main-slider-one__item">
//                   <div className="main-slider-one__bg" style={{ backgroundImage: "url('/assets/images/backgrounds/slider-1.jpg')", }}></div>
//                   {/* <!-- bg --> */}
//                   <div className="main-slider-one__overlay-one"></div>
//                   <div className="main-slider-one__overlay-two"></div>
//                   <div className="container">
...
//                     style={{
//                       backgroundImage:
//                         "url('/assets/images/backgrounds/slider-1.jpg')",
//                     }}
//                   ></div>
//                   {/* <!-- bg --> */}
//                   <div className="main-slider-one__overlay-one"></div>
